  ...
  <header id="header">
		...
		<div id="header_exit"></div>
			...
			<ul>
				...
				<li class="active"><a href="<?php echo URL::to('client').'/files' ?>" >Файлы</a></li>
...
echo '<td class="col_2"><a   href = "'. URL::to('client/show/'.$item->id) .'">' ;
 if(isset($item->filename)) echo  $item->filename ;
echo '</a></td>' ;

echo '<td class="col_3"><a class="downl" href="'. URL::to('client/show') . '/' . $item->id .'"></a><a class="del" href="' . URL::to('client/deletefile') . '/' . $item->id . '"></a>
</td></tr>';
...
?>
  ...
  <div class="empty" style="display:none;">
   <p style="position:relative;">Нет файлов, соответствующих критериям поиска.</p>
   </div>
