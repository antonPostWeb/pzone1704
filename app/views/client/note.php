 ...
 function attach_calendar() {
  ...
  <header id="header">
		...
		<div id="header_exit"></div>
			...
			<li class="active"><a href="<?php echo URL::to('client').'/note' ?>">Заметки</a></li>
                    ...
                    foreach(Note::where('user_id','=',$cur_user)->orderBy('created_at','ASC')->get() as $item){
                        echo ' <tr class="row" id = "'. $item->id .'"> <td class="col_1"> <a class="pasiv"></a></td>';
                            ...
                            if(isset($item->text)){
                             ...
                             echo '<td class="col_3"><a class="del" href="'. URL::to('client/deletenote') . '/' . $item->id . '"></a><a class="edit" note_id="'. $item->id .'"></a>
  </td>
  </tr>';
                        ...
                        echo ' <tr class="row row_edit" id = "'. $item->id .'"> <td class="col_1"> <a class="pasiv"></a></td>';
                            ...
                            if(isset($item->text)){
                             ...
                             echo '  <td class="col_3"><button id = "'. $item->id .'" class="editnote" >Сохранить</button></td>
  ...
  <ul>
			...
			<li id="calendar_footer">Календарь</a></li>
			<li><a href="files.html" >Файлы</a></li>
			<li><a href="note.html" >Заметки</a></li>
...
$('button[class="editnote"]').click(function(){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo Url::to('client/editnote')?>",
		data:{
...
rules: {
    ...
    newnote: {
        ...
        required: "Нельзя сохранить пустую заметку",
		}
