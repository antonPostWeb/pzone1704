...
?>    
                ...
                <form id="createmessage" method = "POST" action = "<?php echo URL::to('manager/createmessage')?>" name = "sms"  enctype="multipart/form-data" >
                    <div id="send_message_wrapper">
                        	Сообщение:
                            <textarea style="word-wrap:break-word;" WRAP=PHYSICAL   name = "sms" ></textarea>
