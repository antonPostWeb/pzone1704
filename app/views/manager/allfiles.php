...
$("#exit_link" ).click(function() {
		$('.notification_wrapper').slideDown(500);
		setTimeout(function(){$('.notification_wrapper').slideUp(500);	
		},7000);
  	});
  	}
</script>
...
<body>
   ...
   <input type="submit" id="send_note" value="Сохранить">
     ...
     function fast_note(){$("#fast_note").toggle();}
		...
		<div class="headline">Выберите пользователя</div>
                              ...
                              $lastmessage = Message::where('client_id','=',$client_id)->where('manager_id','=',$manager_id)->orderBy('created_at','DESC')->first();
                                ...
                                echo    '<div class="message_wrapper" id="'. $item->id .'"   > <a href="'. URL::to('manager/showchat') . '/' . $client_id .'">
                                        ...
                                        <div class="text_in_mes" style="word-wrap:break-word;position:relative;height:100%;">
                                            <p class="message_date" style="position:relative;margin-top:10px;">';
                                            ...
                                            echo '</p>';
                                            echo '<a class="lastmessage" href = "' . Url::to('manager/files') . '/' . $client_id . '"><h2 style="margin-left:15%;margin-top:25px;">Файлы</h2></a>';
                                            echo '</p>
